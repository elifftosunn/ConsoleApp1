    ...
    class Program
    {
        static void Main(string[] args)
        {
            /*
              ...
              Ctrl+C =>kopyalama Ctrl+V =>Alt satıra ekleme Ctrl+Z =>Geri Alma

            */

            //"ternary operatörü" =>  Tek satırda hem kontrolü hem cevabı sağlayan bir koşul-şart operatörü.
            int saat = 20;
            string sonuc = (saat < 17) ? "İyi günler" : "İyi akşamlar";
            Console.WriteLine(sonuc);

            //switch-case => çok fazla kontrol edilmesi gereken şarta bağlı durumda if bloklarının yerine kullanılan bilen döngülerdir.
